...
export const getAddedToTeamToastMessage = (name) => `${capitalize(name)} se agregó al equipo`;
export const getRemovedFromTeamToastMessage = (name) => `${capitalize(name)} se quitó del equipo`;
