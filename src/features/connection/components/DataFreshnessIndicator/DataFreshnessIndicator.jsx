...
import { Wrapper } from 'src/features/connection/components/DataFreshnessIndicator/DataFreshnessIndicator.styles.js';
...
const DataFreshnessIndicator = () => {
  ...
  return (
    <Wrapper>
      ...
      <Button onClick={handleRefresh} disabled={!isOnline || isFetching}>
        {REFRESH_LABEL}
      </Button>
    </Wrapper>
  );
